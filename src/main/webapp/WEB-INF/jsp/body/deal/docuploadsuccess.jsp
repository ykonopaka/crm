						...
						<tr valign="top">
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									...
									<tr>
										<th valign="top"><s:message code="label.header.deal.upload.doc.finished.success" /></th>
										<td>${file}</td>
									</tr>
									<tr>
										<th/>
										<td/>
										<a href="${contextPath}/workflow/deal/${dealId}/docs/upload"><s:message code="label.header.deal.upload.doc.link" /></a>
									</tr>
									<tr>
										<th/>
										<td/>
