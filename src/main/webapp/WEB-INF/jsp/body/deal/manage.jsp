		...
		<tr>
			...
			<td>
				<div id="content-table-inner">
					...
					<h2>
						<a href="${contextPath}/workflow/adddeal">
							<s:message code="link.add.new.deal" />
						</a>
					</h2>
							...
							<table class="datatable" border="0" width="100%" cellpadding="0" cellspacing="0"
								...
								<c:forEach var="deal" items="${dealsList}">
										<tr>
											...
											<td>${deal.customer.workingPlace.jobType.code}</td>
											<td>${deal.customer.credit.amount}</td>
											<td>${deal.customer.credit.term}</td>
											<td>${creationDate}</td>
