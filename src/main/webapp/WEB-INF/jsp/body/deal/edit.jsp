								...
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="deal">
										<tr><th><h2><s:message code="label.header.view.deal.h2.deal" /></h2></th>
											<c:if test="${not empty deal.continueLink}">
												<td><h3><a class="table_edit" href="${contextPath}/${deal.continueLink}">   <s:message code="label.view.deal.continue.link" /></a></h3></td>
											</c:if>
										</tr>
										<tr>
										...
										<tr class="border-line-top">
											<th valign="top"><s:message code="label.view.deal.operator.name"/></th>
										...
										<tr class="border-line-top">
											<th valign="top"><s:message code="label.view.deal.state"/></th>
											<td>${deal.dealStateType.description}</td>
										</tr>
										<tr class="border-line-top">
											<th valign="top"><s:message code="label.view.deal.workflow.side"/></th>
											<td>${deal.dealWorkflowSideType.description}</td>
										</tr>
										<tr class="border-line-top">
											<th valign="top"><s:message code="label.view.deal.workflow.type"/></th>
											<td>${deal.dealWorkflowType.description}</td>
										</tr>																														
										<tr><th /></tr>
										<tr><th /></tr>
										<c:if test="${deal.step >= 1}">
										<tr><th><h2><s:message code="label.header.view.deal.h2.credit" /></h2></th><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/credit/${deal.credit.id}">   <s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
										<tr>
										...
										<tr><th><h2><s:message code="label.header.view.deal.h2.personal.data" /></h2></th></tr>
											<tr><td><h3><s:message code="label.header.view.deal.h3.client" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/customer/${deal.customer.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<tr>
										...
										<tr><td><h3><s:message code="label.header.view.deal.h3.passport" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/passport/${deal.customer.passport.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<tr>
										...
										<c:if test="${deal.step >= 4}">
											<tr><td><h3><s:message code="label.header.view.deal.h3.marriage" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/marriage/${deal.customer.marriage.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<tr>
										...
										<tr><th><h2><s:message code="label.header.view.deal.h2.contact.points" /></h2></th></tr>
											<tr><td><h3><s:message code="label.header.view.deal.h3.address" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/address/${deal.customer.address.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<tr>
											...
											<c:if test="${not empty deal.customer.address.aDistrict}">
												<tr>
													<th/>
													<td><s:message code="label.view.customer.actual.address.district" /><jsp:text>   </jsp:text>${deal.customer.address.aDistrict}</td>
												</tr>
											</c:if>
											<c:if test="${not empty deal.customer.address.aStreet}">
												<tr>
													<th/>
													<td><s:message code="label.view.customer.actual.address.street" /><jsp:text>   </jsp:text>${deal.customer.address.aStreet}</td>
												</tr>
											</c:if>
											<c:if test="${not empty deal.customer.address.aHouse}">
												<tr>
													<th/>
														<td><s:message code="label.view.customer.actual.address.house" /><jsp:text>   </jsp:text>${deal.customer.address.aHouse}</td>
												</tr>
											</c:if>											
											<c:if test="${not empty deal.customer.address.aBuilding}">
												<tr>
													<th/>
														<td><s:message code="label.view.customer.actual.address.building" /><jsp:text>   </jsp:text>${deal.customer.address.aBuilding}</td>
												</tr>
											</c:if>
											<c:if test="${not empty deal.customer.address.aApartment}">
												<tr>
													<th/>
														<td><s:message code="label.view.customer.actual.address.apartment" /><jsp:text>   </jsp:text>${deal.customer.address.aApartment}</td>
												</tr>
											</c:if>
											<tr>
												<th/>
										...
										<c:if test="${deal.step >= 6}">										
											<tr><td><h3><s:message code="label.header.view.deal.h3.phones" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/phoneset/${deal.customer.customerPhoneSet.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<tr>
										...
										<c:if test="${deal.step >= 7}">																																										
											<tr><td><h3><s:message code="label.header.view.deal.h3.contact.people" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/contactpeople/${deal.customer.contactPersons.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											...
											<c:if test="${not empty deal.customer.contactPersons.fpMobileNumber}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.fpHomeWorkNumber}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.fpBirthDate}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.fpAddress}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.spMobileNumber}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.spHomeWorkNumber}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.spBirthDate}">
											<tr class="border-line-top">
											...
											<c:if test="${not empty deal.customer.contactPersons.spAddress}">
											<tr class="border-line-top">
										...
										<tr><th><h2><s:message code="label.header.view.deal.h2.job" /></h2></th></tr>
											<tr><td><h3><s:message code="label.header.view.deal.h3.working.place" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/workingplace/${deal.customer.workingPlace.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<tr>
											...
											<c:if test="${not empty deal.customer.workingPlace.district}">
												<tr>
													<th/>
													<td><s:message code="label.view.customer.working.place.address.district" /><jsp:text>   </jsp:text>${deal.customer.workingPlace.district}</td>
												</tr>
											</c:if>
											<c:if test="${not empty deal.customer.workingPlace.street}">
												<tr>
													<th/>
													<td><s:message code="label.view.customer.working.place.address.street" /><jsp:text>   </jsp:text>${deal.customer.workingPlace.street}</td>
												</tr>
											</c:if>
											<c:if test="${not empty deal.customer.workingPlace.house}">
												<tr>
													<th/>
														<td><s:message code="label.view.customer.working.place.address.house" /><jsp:text>   </jsp:text>${deal.customer.workingPlace.house}</td>
												</tr>
											</c:if>											
											<c:if test="${not empty deal.customer.workingPlace.building}">
												<tr>
													<th/>
														<td><s:message code="label.view.customer.working.place.address.building" /><jsp:text>   </jsp:text>${deal.customer.workingPlace.building}</td>
												</tr>
											</c:if>
											<c:if test="${not empty deal.customer.workingPlace.office}">
												<tr>
													<th/>
														<td><s:message code="label.view.customer.working.place.address.office" /><jsp:text>   </jsp:text>${deal.customer.workingPlace.office}</td>
												</tr>
											</c:if>																							
											<tr class="border-line-top">
										...
										<tr><td><h3><s:message code="label.header.view.deal.h3.additional.working.place" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/additionalwp/${deal.customer.additionalWorkingPlace.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<c:choose>
										...
										<tr><td><h3><s:message code="label.header.view.deal.h3.previous.working.place" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/previouswp/${deal.customer.previousWorkingPlace.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											<c:choose>
										...
										<tr><th><h2><s:message code="label.header.view.deal.h2.finances.credits" /></h2></th></tr>
											<tr><td><h3><s:message code="label.header.view.deal.h3.income.outcome" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/incomeoutcome/${deal.customer.incomeOutcome.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
												<tr>
										...
										<tr><td><h3><s:message code="label.header.view.deal.h3.property" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/property/${deal.customer.property.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
											...
											<tr><td><h3><s:message code="label.header.view.deal.h3.credit.cards" /></h3></td><td><h3><a class="table_edit" href="${contextPath}/workflow/edit/deal/${deal.id}/creditcard/${deal.customer.creditCard.id}"><s:message code="label.view.deal.edit.link" /></a></h3></td></tr>
										...
										<c:if test="${deal.step >= 13}">												
											<tr><th><h2><s:message code="label.header.view.deal.h2.files" /></h2></th><td><h3><a class="table_edit" href="${contextPath}/workflow/deal/${deal.id}/files/upload"><s:message code="label.view.deal.attach.files" /></a></h3></td></tr>
											<c:forEach var="file" items="${filesList}">
											<tr>
													<th/>
													<td>
														<a class="table_edit" href="${contextPath}/uploads/${deal.id}/files/${file.fileName}" target="_blank">${file.fileName}</a>
													</td>
											</tr>
											</c:forEach>
										</c:if>
										<c:if test="${deal.step >= 13}">												
											<tr><th><h2><s:message code="label.header.view.deal.h2.actions" /></h2></th><td class="table_edit"><b><s:message code="label.view.deal.available.actions" /></b></td></tr>
											<c:forEach var="action" items="${actionsList}">
											<tr>
													<th/>
													<td>
														<a class="table_edit" href="${contextPath}/${action.link}">${action.name}</a>
													</td>
											</tr>
											</c:forEach>
										</c:if>
										<c:if test="${deal.step >= 13}">												
											<tr><th><h2><s:message code="label.header.view.deal.h2.documents" /></h2></th>
												<security:authorize access="hasRole('COORDINATOR')">
													<td><h3><a class="table_edit" href="${contextPath}/workflow/deal/${deal.id}/docs/upload"><s:message code="label.view.deal.attach.documents" /></a></h3></td>
												</security:authorize>
											...
											<tr>
												...
												<security:authorize access="hasRole('OPERATOR')">
													<td class="table_edit"><b><s:message code="label.view.deal.available.documents" /></b></td>
												</security:authorize>
											</tr>
											...
											<tr>
													<th/>
													<td>
														<a class="table_edit" href="${contextPath}/uploads/${deal.id}/docs/${doc.fileName}" target="_blank">${doc.fileName}</a>
													</td>
											</tr>
											</c:forEach>
										</c:if>
										<tr><th><h2><s:message code="label.header.view.deal.h2.comments" /></h2></th><td><h3><a class="table_edit" href="${contextPath}/workflow/deal/${deal.id}/comment/add"><s:message code="label.view.deal.add.comment" /></a></h3></td></tr>
										<c:forEach var="comment" items="${commentsList}">
											<tr>
												<th/>
												<td class="border-line-top">
													<div class="comment">
													<p><b><fmt:formatDate value="${comment.date}" pattern="dd.MM.yyyy HH:mm:ss"/></b></p>
													<p><b><i>${comment.user.lastName} ${comment.user.firstName} :</i></b></p>
													<p>${comment.text}</p>
													</div>
												</td>
											</tr>
