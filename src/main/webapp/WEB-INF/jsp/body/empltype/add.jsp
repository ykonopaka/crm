						...
						<tr valign="top">
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="employmentType">
										<tr>
											<th valign="top"><s:message code="label.add.new.employment.type.description"/></th>
										...
										<tr>
											...
											<td valign="top"><input name="commit" type="submit"
												...
												<a class="form-reset-${locale}" href="${contextPath}/administration/manageempltypes"></a>
											</td>
										</tr>
									</form:form>
								</table>
