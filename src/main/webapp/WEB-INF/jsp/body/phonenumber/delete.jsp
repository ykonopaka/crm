								...
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="phoneNumber">
										<tr class="border-line">
											<th valign="top"><s:message code="label.delete.phone.number.phoneNumber"/></th>
											<td>${phoneNumber.phoneNumber}</td>
										</tr>
										<tr class="border-line">
											<th valign="top"><s:message code="label.delete.phone.number.description"/></th>
											<td>${phoneNumber.description}</td>
										</tr>
										<tr class="border-line">
											<th valign="top"><s:message code="label.delete.phone.number.office"/></th>
											<c:choose>
												...
												<c:otherwise>
													<td><s:message
															code="label.users.table.options.no.office" /></td>
												</c:otherwise>
											</c:choose>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.phone.number.is.mobile"/></th>
											<td>${phoneNumber.isMobile}</td>
										</tr>
										<tr>
											<th />
										</tr>
										<tr>
											...
											<td valign="top"><input name="commit" type="submit"
												...
												<a class="form-reset-${locale}" href="${contextPath}/administration/managephonenumbers"></a>
											</td>
										</tr>
									</form:form>
								</table>
