									...
									<form:form method="POST" commandName="phoneNumber">
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.phone.number" /></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.phone.number.description" /></th>
										...
										<c:choose>
											<c:when test="${empty officesList}">
												<tr>
													<th class="border-line" valign="top"><s:message
															code="label.add.new.phone.number.office" /></th>
													<td class="border-line" >
													<a
														href="${contextPath}/administration/addoffice">
														<s:message code="link.add.new.office.when.creating.phone.number" />
													</a>
													</td>
													<td/>
												</tr>
										...
										<tr>
											<th valign="top"><s:message
													code="label.add.new.phone.number.is.mobile" /></th>
