							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="client">
										<tr>
											<th valign="top"><s:message code="label.delete.client.id"/></th>
											<td>${client.id}</td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.client.last.name"/></th>
											<td>${client.lastName}</td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.client.first.name"/></th>
											<td>${client.firstName}</td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.client.middle.name"/></th>
