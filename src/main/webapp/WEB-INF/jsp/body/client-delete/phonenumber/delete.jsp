							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="clientPhoneNumber">
										<tr>
											<th valign="top"><s:message code="label.delete.client.phone.number.phoneNumber.id"/></th>
											<td>${clientPhoneNumber.id}</td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.client.phone.number.phoneNumber"/></th>
											<td>${clientPhoneNumber.phoneNumber}</td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.client.phone.number.description"/></th>
											<td>${clientPhoneNumber.description}</td>
										</tr>
										<tr>
											<th />
										</tr>
