									...
									<form:form method="POST" commandName="infoSource">
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.info.source.type" /></th>
											<td class="border-line"><form:select path="infoSourceType.id" type="text"
													items="${infoSourceTypesList}" itemValue="id"
													itemLabel="description" class="inp-form-select" /></td>
											<td/>
										</tr>
										<tr>
											<th valign="top"><s:message
													code="label.add.new.info.source.details" /></th>
											<td><form:input path="details" type="text"
													class="inp-form" /></td>
											<td><form:errors path="details" element="p"
										...
										<tr>
											...
											<a class="form-reset-${locale}" href="${contextPath}/administration/manageinfosources"></a></td>
											<td/>
										</tr>
									</form:form>
								</table>
