								...
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="client">
										...
										<tr >
											...
											<td><input type="radio" name="employment_type"
												id="employment_type_select" checked="checked" value="select" />
												<label for="employment_type_select"><s:message
														code="label.add.call.new.client.choose.employment.type.select" /></label></td>
											<td/>
										</tr>
										<tr >
											<th />
										...
										<tr>
											<th />
											<td><input type="radio" name="employment_type"
												id="employment_type_input" value="input" /> <label
												for="employment_type_input"><s:message
														code="label.add.call.new.client.choose.employment.type.input" /></label></td>
											<td/>														
										</tr>
										<tr>
											<th />
											...
											<tr>
												<c:choose>
													<c:when test="${status.index==0}">
														<th valign="top"><s:message
																code="label.add.call.new.client.phone.numbers" /></th>
													</c:when>
													<c:otherwise>
														<th />
													</c:otherwise>
										...
										<tr >
											...
											<td valign="top"><input name="commit" type="submit"
												...
												href="${contextPath}/workflow/managecalls/init"></a></td>
											<td/>
										</tr>
