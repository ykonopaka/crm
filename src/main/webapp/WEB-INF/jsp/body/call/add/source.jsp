							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="callWrapper">
										<tr>
											<th valign="top">
												<s:message code="label.add.call.information.source"/>
											</th>
											<td>
												<form:select path="infoSource.id" type="text"
													items="${infoSourcesList}" itemValue="id" itemLabel="fullName" cssStyle="width: 388px;"
