							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="clientPhoneNumber">
										<tr>
											<th class="border-line" valign="top"><s:message code="label.add.call.new.client.phone.number"/></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.call.new.client.phone.is.hidden" /></th>
											<td class="border-line"><form:checkbox path="isHidden"/></td>
											<td/>
										</tr>
										<tr>
											<th valign="top"><s:message
													code="label.add.call.new.client.phone.has.client.come" /></th>
											<td><form:checkbox path="hasClientCome"/></td>
											<td/>
										</tr>
										<tr>
											<th />
