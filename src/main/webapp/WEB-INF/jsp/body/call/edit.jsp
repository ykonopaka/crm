							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="call">
										...
										<td><h3><a class="table_edit" href="${contextPath}/workflow/edit/call/${call.id}/client/${call.client.id}">   <s:message code="label.view.call.edit.link" /></a></h3></td>
										</tr>
										<tr>
										...
										<td><h3><a class="table_edit" href="${contextPath}/workflow/edit/call/${call.id}/officephone/${call.officePhoneNumber.id}">   <s:message code="label.view.call.edit.link" /></a></h3></td>
										</tr>										
										<tr>
										...
										<td><h3><a class="table_edit" href="${contextPath}/workflow/edit/call/${call.id}/credit/${call.credit.id}">   <s:message code="label.view.call.edit.link" /></a></h3></td>
										</tr>	
										<tr>
										...
										<td><h3><a class="table_edit" href="${contextPath}/workflow/edit/call/${call.id}/source/${call.infoSource.id}">   <s:message code="label.view.call.edit.link" /></a></h3></td>
										</tr>																																																		
										<tr>
										...
										<td><h3><a class="table_edit" href="${contextPath}/workflow/edit/call/${call.id}/additionalinfo/${call.additionalCallInfo.id}">   <s:message code="label.view.call.edit.link" /></a></h3></td>										
										</tr>																																																		
										<tr>
										...
										<td><h3><a class="table_edit" href="${contextPath}/workflow/edit/call/${call.id}/clientphone/${call.clientPhoneNumber.id}">   <s:message code="label.view.call.edit.link" /></a></h3></td>										
										</tr>																																																		
										<tr>
