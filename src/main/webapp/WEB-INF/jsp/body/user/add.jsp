									...
									<form:form method="POST" commandName="user">
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.user.settings.username" /></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.user.settings.first.name" /></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.user.settings.last.name" /></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.user.settings.password" /></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.user.settings.confirm.password" /></th>
											<td class="border-line"><form:input path="confirmNewPassword"
													type="password" class="inp-form" /></td>
											<td><form:errors path="confirmNewPassword" element="p"
													cssClass="inp-form-error" /></td>
										</tr>
										<tr>
											<th class="border-line" valign="top"><s:message
													code="label.add.new.user.settings.email" /></th>
											...
											<c:when test="${empty officesList}">
												<tr>
													...
													<a
														...
														<s:message code="link.add.new.office.when.creating.user" />
													</a>
													</td>
										...
										<tr>
											<th valign="top"><s:message
													code="label.add.new.user.settings.role" /></th>
											<td>
												<div>
