							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="office">
										<tr>
											<th class="border-line" valign="top"><s:message code="label.add.new.office.name"/></th>
										...
										<tr>
											<th class="border-line" valign="top"><s:message code="label.add.new.office.address"/></th>
										...
										<tr>
											<th valign="top"><s:message code="label.add.new.office.description"/></th>
