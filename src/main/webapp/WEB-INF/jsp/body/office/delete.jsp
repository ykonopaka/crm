								...
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="office">
										<tr class="border-line">
											<th valign="top"><s:message code="label.delete.office.name"/></th>
											<td>${office.name}</td>
										</tr>
										<tr class="border-line">
											<th valign="top"><s:message code="label.delete.office.address"/></th>
											<td>${office.address}</td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.delete.office.description"/></th>
