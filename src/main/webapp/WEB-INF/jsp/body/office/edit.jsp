							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" id="id-form">
									<form:form method="POST" commandName="office">
										<tr>
											<th class="border-line" valign="top"><s:message code="label.edit.office.name"/></th>
											<td class="border-line"><form:input path="name" type="text"
													class="inp-form" /></td>
											<td><form:errors path="name" element="p"
													cssClass="inp-form-error" /></td>
										</tr>
										<tr>
											<th class="border-line" valign="top"><s:message code="label.edit.office.address"/></th>
											<td class="border-line"><form:input path="address" type="text"
													class="inp-form" /></td>
											<td><form:errors path="address" element="p"
													cssClass="inp-form-error" /></td>
										</tr>
										<tr>
											<th valign="top"><s:message code="label.edit.office.description"/></th>
										...
										<tr>
											...
											<td valign="top"><input name="commit" type="submit"
												...
												<a class="form-reset-${locale}" href="${contextPath}/administration/manageoffices"/>
											</td>
										</tr>
									</form:form>
								</table>
